...
def main(task, path, filename1, filename2):
    ...
    if task == 'show_data':
        ...
        print('Enter the correct task: show_data, region_overlap, pearson_corr_coef, seg_func_mean')
...
if __name__ == '__main__':
    ...
    parser.add_argument('task', type = str, help = 'Enter the task: show_data, region_overlap, pearson_corr_coef, seg_func_mean')
